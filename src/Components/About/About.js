    ...
    return (
        <div id="about" className="about-div">
            ...
            <div className="about-desc"> 
                ...
                I'm based in Dhaka, Bangladesh, but I'm happy working <span className="strong-text">remotely</span> and have expreience in remote teams. With a Good foundation in <span className="strong-text">Computer Science principles</span>  and Passion for continuous learning, I am eager to use my skills to make a <span className="strong-text">Meaningful Impact</span>  on a dynamic team. When I'm not coding, you'll find me outdoors. I love being out in nature whether that's going for a walk, run or motorcycling or having a journey by Boat. I'd love you to check out my works. </p>
            </div>
        </div>
    );
};
